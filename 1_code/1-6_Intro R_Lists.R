...
my_list 
# Another way is assigning the names first with names():
...
# In some cases you want to disassemble a list to its atomic components. Unlist() produces a vector which contains all these components: unlist(my_list).
unlist(shining_list)