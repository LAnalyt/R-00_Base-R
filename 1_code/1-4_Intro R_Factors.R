...
# There are two categories here, or the "factor levels" here are "Male" and "Female":
# Convert sex_vector to a factor
factor_sex_vector <- factor(sex_vector)
# Print out to see the factor levels:
factor_sex_vector # Levels: Female Male
...
factor_animals_vector # Levels: Donkey Elephant Giraffe Horse. 
...
factor_temperature # Levels: Low < Medium < High. 
...
# "Male" and "Female" are nominal (unordered) factors levels and can't be compared.
