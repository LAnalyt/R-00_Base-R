...
# Analyze the box office numbers of the Star Wars :
...
# The new vector world_wide_vector is not yet a part of the matrix. Use cbind() function to merge matrices and/or vectors together by column.
...
# Whereas vectors have one dimension, matrices have two dimensions. Use a comma to separate the rows from the columns.
# my_matrix[1,2] selects the element at the first row and second column
# my_matrix[1:3,2:4] results in a matrix with the data on the rows 1,2,3 and columns 2,3,4.
# For selecting all elements of a row or a column, no number is needed before or after the comma, respectively.
