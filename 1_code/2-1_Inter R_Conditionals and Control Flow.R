...
# Create 2 vectors containing the number of views on social media for the last 7 days:
...
# R also provides a way to use the results of the operators to change the behavior of R scripts.
